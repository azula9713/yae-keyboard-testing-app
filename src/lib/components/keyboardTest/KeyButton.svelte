...
<div class="h-16 min-w-14 {key.flexGrow ? 'flex-grow' : ''}">
	...
	>
		<div class="w-full h-14 absolute -top-[2px] left-0 flex items-center justify-between blur-sm">
		...
		<div
			class="relative h-11 border border-primary-100 flex-grow bg-gradient-to-b from-primary-50 to-primary-100 flex pt-1 pl-1 rounded"
		>
			<span class="leading-none font-semibold text-[14px]"
